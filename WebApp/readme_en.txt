...
○ Database management system: Microsoft SQL Server 2017 (подойдёт и более ранний SQL Server 2012).
○ Platform: .NET 6.0.
...
This project appeared as a result of my study of the Blazor technology in the fall of 2024 and is a useful exercise. The idea was suggested by my friend Alexander Garbuzov, who asked for help to finalize the training project in Python and MySQL. He kindly allowed us to use the list of test questions and answers. 
